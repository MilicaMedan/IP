...
public class UserDAO {
	...
	private static final String SQL_SELECT_BY_USERNAME_AND_PASSWORD = "SELECT * FROM user WHERE username=? AND passwordHash=? AND isAdmin=1 AND active=1";
	...
	private static final String SQL_SELECT = "SELECT * FROM user WHERE id!=? AND active=1";
	...
	public static boolean insertFromReq(SignupRequest req) {
